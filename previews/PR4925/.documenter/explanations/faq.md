...
### No `Scene` displayed or GLMakie fails to build {#No-Scene-displayed-or-GLMakie-fails-to-build}
...
## Plotting issues {#Plotting-issues}

### Dimensions too large {#Dimensions-too-large}
...
#### 2d plots (heatmaps, images, etc.) {#2d-plots-heatmaps,-images,-etc.}
...
<img src="https://user-images.githubusercontent.com/32143268/55675737-96357280-5894-11e9-9170-1ffd21f544cc.png" alt="untiled heatmap">
...
<img src="https://user-images.githubusercontent.com/32143268/61105143-a3b35780-a496-11e9-83d1-bebe549aa593.png" alt="tiled heatmap">


#### 3d plots (volumes) {#3d-plots-volumes}
...
### My font doesn&#39;t work! {#My-font-doesn't-work!}
...
`GridLayout`s work by fitting all their child content into the space that is available to them. Therefore, the `Figure` size determines how the layout is solved, but the layout does not influence the `Figure` size.

This works well when all content is adjustable in width and height, such as an `Axis` that can shrink or grow as needed. But it is also possible to constrain elements or rows/columns in width, height or aspect. And if too many elements have such constraints, it&#39;s not possible any longer to fit them all into the given `Figure` size, without leaving whitespace or clipping them at the borders.
