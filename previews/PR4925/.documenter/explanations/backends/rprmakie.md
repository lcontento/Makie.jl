...
<summary><a id='RPRMakie.activate!' href='#RPRMakie.activate!'><span class="jlbinding">RPRMakie.activate!</span></a> <Badge type="info" class="jlObjectType jlFunction" text="Function" /></summary>
...
<Badge type="info" class="source-link" text="source"><a href="https://github.com/MakieOrg/Makie.jl/blob/ed5c32afa1cb61b4252cfedd843dc69568f104e0/RPRMakie/src/RPRMakie.jl#L47-L57" target="_blank" rel="noreferrer">source</a></Badge>
...
There are several examples showing different aspects of how to use RPRMakie. The examples are in [RPRMakie/examples](https://github.com/MakieOrg/Makie.jl/tree/master/RPRMakie/examples)

## MaterialX and predefined materials (materials.jl) {#MaterialX-and-predefined-materials-materials.jl}

There are several predefined materials one can use in RadeonProRender. RPR also supports the [MaterialX](https://www.materialx.org/) standard to load a wide range of predefined Materials. Make sure to use the Northstar backend for `MaterialX`.
...
## Advanced custom material (earth_topography.jl) {#Advanced-custom-material-earth_topography.jl}
...
![](../../assets/topographie.png)


## RPRMakie interop (opengl_interop.jl) {#RPRMakie-interop-opengl_interop.jl}

RPRMakie doesn&#39;t support layouting and sub scenes yet, but you can replace a single scene with a RPR rendered, interactive window. This is especially handy, to show 2d graphics and interactive UI elements next to a ray traced scene and interactively tune camera and material parameters.
...
## Animations (lego.jl) {#Animations-lego.jl}
