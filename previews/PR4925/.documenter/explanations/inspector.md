...
<summary><a id='Makie.DataInspector' href='#Makie.DataInspector'><span class="jlbinding">Makie.DataInspector</span></a> <Badge type="info" class="jlObjectType jlType" text="Type" /></summary>
...
## Extending `DataInspector` {#Extending-DataInspector}
...
## Per-plot `show_data` {#Per-plot-show_data}
