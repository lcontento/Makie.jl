...
Let&#39;s say you have some data in a matrix and want to plot it exactly as it is. More explicitly you want each drawn pixel to sample from exactly one value of your matrix with no interpolation taking place. This tutorial will explain how to do this.
...
## Pixel Perfect Plotting in a Figure {#Pixel-Perfect-Plotting-in-a-Figure}
